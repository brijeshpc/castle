    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ asset('/public/pages/layout/top-nav.html') }}"><i class="fa fa-circle-o"></i> Top Navigation</a></li>
            <li><a href="{{ asset('/public/pages/layout/boxed.html') }}"><i class="fa fa-circle-o"></i> Boxed</a></li>
            <li><a href="{{ asset('/public/pages/layout/fixed.html') }}"><i class="fa fa-circle-o"></i> Fixed</a></li>
            <li><a href="{{ asset('/public/pages/layout/collapsed-sidebar.html') }}"><i class="fa fa-circle-o"></i> Collapsed Sidebar</a></li>
          </ul>
        </li>
        <li>
          <a href="{{ asset('/public/ages/widgets.html') }}">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ asset('/public/pages/charts/chartjs.html') }}"><i class="fa fa-circle-o"></i> ChartJS</a></li>
            <li><a href="/public/pages/charts/morris.html"><i class="fa fa-circle-o"></i> Morris</a></li>
            <li><a href="{{ asset('/public/pages/charts/flot.html') }}"><i class="fa fa-circle-o"></i> Flot</a></li>
            <li><a href="{{ asset('/public/pages/charts/inline.html') }}"><i class="fa fa-circle-o"></i> Inline charts</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ asset('/public/pages/UI/general.html') }}"><i class="fa fa-circle-o"></i> General</a></li>
            <li><a href="{{ asset('/public/pages/UI/icons.html') }}"><i class="fa fa-circle-o"></i> Icons</a></li>
            <li><a href="{{ asset('/public/pages/UI/buttons.html') }}"><i class="fa fa-circle-o"></i> Buttons</a></li>
            <li><a href="{{ asset('/public/pages/UI/sliders.html') }}"><i class="fa fa-circle-o"></i> Sliders</a></li>
            <li><a href="{{ asset('/public/pages/UI/timeline.html') }}"><i class="fa fa-circle-o"></i> Timeline</a></li>
            <li><a href="{{ asset('/public/pages/UI/modals.html') }}"><i class="fa fa-circle-o"></i> Modals</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
        ...
        <li>
          <a href="{{ asset('/public/pages/mailbox/mailbox.html') }}">
